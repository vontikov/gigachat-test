...
func (FunctionCallPolicy_Mode) Descriptor() protoreflect.EnumDescriptor {
	return file_gigachat_proto_enumTypes[0].Descriptor()
}

func (FunctionCallPolicy_Mode) Type() protoreflect.EnumType {
	return &file_gigachat_proto_enumTypes[0]
}
...
func (FunctionCallPolicy_Mode) EnumDescriptor() ([]byte, []int) {
	return file_gigachat_proto_rawDescGZIP(), []int{2, 0}
}
...
type ChatOptions struct {
	...
	// *
	// Поле, которое отвечает за то, как GigaChat будет [работать с функциями](/docs/ru/gigachat/api/function-calling).
...
type Message struct {
	...
	// - `function` — сообщение с результатом работы [пользовательской функции](/docs/ru/gigachat/api/function-calling#rabota-s-sobstvennymi-funktsiyami). В сообщении с этой ролью передавайте в поле `content` валидный JSON-объект с результатами работы функции.
	// Для сохранения контекста диалога с пользователем передайте несколько сообщений. Подробнее читайте в разделе [Работа с историей чата](/docs/ru/gigachat/api/keeping-context).
	...
	// Позволяет сохранить [контекст вызова функции](/docs/ru/gigachat/api/function-calling#sohranenie-konteksta) и повысить качество работы модели.
	...
	//
	// Идентификатор присваивается файлу при [загрузке в хранилище](/docs/ru/gigachat/api/reference/rest/post-file). Посмотреть список файлов в хранилище можно с помощью метода [`GET /files`](/docs/ru/gigachat/api/reference/rest/get-files).
	//
	// В одном запросе можно передать только одно изображение. В одной сессии можно передать до 10 изображений.
	// Подробнее — в разделе [Генерация с помощью файлов изображений](/docs/ru/gigachat/api/working-with-files)
...
type ModelInfo struct {
	...
	// Название модели
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Версия модели. Подробнее о версиях — в разделе [Обновления моделей](/docs/ru/gigachat/models/updates).
...
func (x *FunctionCall) Reset() {
	*x = FunctionCall{}
	mi := &file_gigachat_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FunctionCall) Descriptor() ([]byte, []int) {
	return file_gigachat_proto_rawDescGZIP(), []int{12}
}
...
func (x *ListModelsRequest) Reset() {
	*x = ListModelsRequest{}
	mi := &file_gigachat_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListModelsRequest) Descriptor() ([]byte, []int) {
	return file_gigachat_proto_rawDescGZIP(), []int{13}
}
...
func (x *ListModelsResponse) Reset() {
	*x = ListModelsResponse{}
	mi := &file_gigachat_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListModelsResponse) Descriptor() ([]byte, []int) {
	return file_gigachat_proto_rawDescGZIP(), []int{14}
}
...
type Model struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Название модели. Описание доступных моделей смотрите в разделе [Модели GigaChat](/docs/ru/gigachat/models).
...
func (x *Model) Reset() {
	*x = Model{}
	mi := &file_gigachat_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Model) Descriptor() ([]byte, []int) {
	return file_gigachat_proto_rawDescGZIP(), []int{15}
}
...
func (x *RetrieveModelRequest) Reset() {
	*x = RetrieveModelRequest{}
	mi := &file_gigachat_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RetrieveModelRequest) Descriptor() ([]byte, []int) {
	return file_gigachat_proto_rawDescGZIP(), []int{16}
}
...
func (x *RetrieveModelResponse) Reset() {
	*x = RetrieveModelResponse{}
	mi := &file_gigachat_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RetrieveModelResponse) Descriptor() ([]byte, []int) {
	return file_gigachat_proto_rawDescGZIP(), []int{17}
}
...
var file_gigachat_proto_rawDesc = string([]byte{
	...
	0x08, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x22, 0xbf, 0x03, 0x0a, 0x0b, 0x43, 0x68,
	0x61, 0x74, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x25, 0x0a, 0x0b, 0x74, 0x65, 0x6d,
	...
	0x12, 0x18, 0x0a, 0x05, 0x74, 0x6f, 0x70, 0x5f, 0x70, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x48,
	0x01, 0x52, 0x04, 0x74, 0x6f, 0x70, 0x50, 0x88, 0x01, 0x01, 0x12, 0x22, 0x0a, 0x0a, 0x6d, 0x61,
	0x78, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x48, 0x02,
	0x52, 0x09, 0x6d, 0x61, 0x78, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x88, 0x01, 0x01, 0x12, 0x32,
	0x0a, 0x12, 0x72, 0x65, 0x70, 0x65, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x65, 0x6e,
	0x61, 0x6c, 0x74, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x02, 0x48, 0x03, 0x52, 0x11, 0x72, 0x65,
	...
	0x65, 0x72, 0x76, 0x61, 0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x02, 0x48, 0x04, 0x52, 0x0e, 0x75,
	...
	0x05, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x12, 0x44, 0x0a, 0x0d, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x63, 0x61, 0x6c, 0x6c, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e,
	0x67, 0x69, 0x67, 0x61, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x75, 0x6e, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x43, 0x61, 0x6c, 0x6c, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x0c,
	0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x33, 0x0a, 0x09,
	0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x15, 0x2e, 0x67, 0x69, 0x67, 0x61, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x75,
	...
	0x65, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x74, 0x6f, 0x70, 0x5f, 0x70, 0x42, 0x0d, 0x0a, 0x0b, 0x5f,
	0x6d, 0x61, 0x78, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x42, 0x15, 0x0a, 0x13, 0x5f, 0x72,
	...
	,
	...
	,
	...
	0x70, 0x4a, 0x04, 0x08, 0x05, 0x10, 0x06, 0x22, 0x78, 0x0a, 0x0b, 0x41, 0x6c, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x74, 0x69, 0x76, 0x65, 0x12, 0x2e, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x67, 0x69, 0x67, 0x61, 0x63, 0x68,
	...
	0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x66,
	...
	0x78, 0x22, 0x82, 0x01, 0x0a, 0x05, 0x55, 0x73, 0x61, 0x67, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x70,
	...
	0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x22, 0x39, 0x0a, 0x09, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x49,
	...
	0x6e, 0x74, 0x73, 0x22, 0x13, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x4d, 0x6f, 0x64, 0x65, 0x6c,
	...
	0x65, 0x6c, 0x52, 0x06, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x22, 0x62, 0x0a, 0x05, 0x4d, 0x6f,
	...
	,
})

var (
	file_gigachat_proto_rawDescOnce sync.Once
	file_gigachat_proto_rawDescData []byte
)

func file_gigachat_proto_rawDescGZIP() []byte {
	file_gigachat_proto_rawDescOnce.Do(func() {
		file_gigachat_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gigachat_proto_rawDesc), len(file_gigachat_proto_rawDesc)))
	})
	return file_gigachat_proto_rawDescData
}

var file_gigachat_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_gigachat_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_gigachat_proto_goTypes = []any{
...
func file_gigachat_proto_init() {
	...
	file_gigachat_proto_msgTypes[1].OneofWrappers = []any{}
	file_gigachat_proto_msgTypes[3].OneofWrappers = []any{}
	file_gigachat_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gigachat_proto_rawDesc), len(file_gigachat_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   18,
			NumExtensions: 0,
			NumServices:   2,
		...
		EnumInfos:         file_gigachat_proto_enumTypes,
